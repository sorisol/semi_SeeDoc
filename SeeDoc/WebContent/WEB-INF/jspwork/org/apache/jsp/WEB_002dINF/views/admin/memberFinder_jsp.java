 ...
 * Generated at: 2020-07-20 06:09:10 UTC
...
if(hospLoggedIn == null && userLoggedIn == null) { 
      ...
      out.write("\t\t\t$(\"#hidden\").css(\"display\", \"\");\r\n");
      out.write("\t\t} else {\r\n");
      out.write("\t\t\t$(\"#hidden\").css(\"display\", \"none\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t});\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#searchType\").change(function(){\r\n");
      out.write("\t\t$(\"#search-memberId, #search-memberName, #search-gender\").hide();\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t$(\"[name=deleteUserFrm]\").submit();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"memberRowPerPage\" value=\"10\">\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
 ...
 if(list == null || list.isEmpty()) {
      out.write("\r\n");
      out.write("            \t<tr>\r\n");
      out.write("            \t\t<td colspan=\"10\"> <h3>조회된 회원이 없습니다.</h3></td>\r\n");
      out.write("            \t</tr>\r\n");
      out.write("            ");
 } else { 
            	 for(User m : list) { 
      ...
      out.write("</td>\r\n");
      out.write("            \t\t<td>");
      out.print( m.getUserPhone() );
      out.write("</td>\r\n");
      out.write("            \t\t<td>");
      out.print( m.getUserGender().equals("M")? '남':'여' );
      out.write("</td>\r\n");
      out.write("            \t\t<td>");
      out.print( m.getUserBirth() );
      out.write("</td>\r\n");
      out.write("            \t\t<td>");
      out.print( m.getUserAddr() );
      out.write("</td>\r\n");
      out.write("            \t\t<td>");
      out.print( m.getUserSymptom() );
      out.write("</td>\r\n");
      out.write("            \t\t<td>");
      out.print( m.getUserEndrollDate() );
      out.write("</td>\r\n");
      out.write("            \t\t<td>\r\n");
      ...
      out.print( m.getUserId());
      out.write("'\"/>\r\n");
      out.write("            \t\t\t<form name=\"deleteUserFrm\" action='");
      out.print(request.getContextPath() );
      out.write("/admin/deleteMember' method='POST'>\r\n");
      ...
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<input type=\"radio\" name=\"searchKeyword\" id=\"gender-M\" value=\"M\" ");
      out.print( "gender".equals(searchType) && "M".equals(searchKeyword) ? "checked": "" );
      out.write("> \r\n");
      out.write("\t\t\t\t<label for=\"gender-M\">남</label>\r\n");
      out.write("\t\t    \t<input type=\"radio\" name=\"searchKeyword\" id=\"gender-F\" value=\"F\" ");
      out.print( "gender".equals(searchType) && "F".equals(searchKeyword) ? "checked": "" );
      out.write(">\r\n");
      out.write("\t\t\t\t<label for=\"gender-F\">여</label>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t    \t<button type=\"submit\">검색</button>\r\n");
      out.write("\t\t    </form>\r\n");
      out.write("\t\t</div>\r\n");
