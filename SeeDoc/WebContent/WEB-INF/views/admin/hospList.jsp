...
<section>
        <div class="res-wrap">
            <h1><span>●</span> 회원조회</h1>
	            <div class="res-card">
	            	<form action="" id="memberSetRows">
						<input type="hidden" name="memberRowPerPage" value="5">
					</form>
            ...
            <% if(list == null || list.isEmpty()) {%>
            	<tr>
            		<td colspan="8"> <h3>조회된 병원이 없습니다.</h3></td>
            	</tr>
            <% } else { 
            	 for(Hospital l : list) { %>
            	<tr class="row">
		...
		<select id="searchType">
			<option value="hospId">아이디</option>		
			<option value="hospName">회원명</option>
			<option value="hospAddr">주소</option>
		</select>
